(function ($) {
    ...
    $('.toggle-btn').on('click', function(e) {
        e.preventDefault();
        $('.glass-social-sidebar').toggleClass('active');
    });
    /*=============================================
            ...
            var carouselSlider = new Swiper('.auto--center-flexible__container', {
                ...
                spaceBetween: 30,
                   ...
                   autoplay: {
                    ...
                    pauseOnMouseEnter: true, // Jab mouse upar aayega toh slider ruk jayega
                ...
                breakpoints: {
                    ...
                    1499:{ slidesPerView: 3 }, // Fixed numbers behtar dikhte hain
    ...
    // 2. MOBILE SLIDER CONFIGURATION
    // Yeh mobile specific logic hai jo 1.2 slides dikhayega (swipe hint ke liye)
    if ($('.mobile-swiper').length > 0) {
        var mobileSlider = new Swiper('.mobile-swiper', {
            slidesPerView: 1.2,       // Agli slide ka thoda hissa dikhega
            centeredSlides: true,     // Center mein rakhega slide ko
            loop: true,
            speed: 600,
            spaceBetween: 15,         // Mobile par kam space behtar hai
            autoplay: {
                delay: 3500,
                disableOnInteraction: false,
            },
