...
@section('title', $privacy->meta_title ?? 'Privacy Policy | Glass Installation')
@section('meta_description', $privacy->meta_description)
@section('meta_keywords', $privacy->meta_keywords)
            ...
            <div class="feature-icon-wrapper section-space--ptb_100 mobile-pad-tp">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center section-space--mb_60">
                        <h6 class="section-sub-title mb-20 theme-color-text">{{ $privacy->heading_1 ?? 'Privacy Policy' }}</h6>
                        <h1 class="font-weight--bold">{{ $privacy->heading_2 ?? 'Privacy Policy' }}</h1>
                    </div>
